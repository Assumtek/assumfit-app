...
sombra. Um card bom no escuro e chapado no claro é o defeito mais provável —
confira nos dois (`xcrun simctl ui booted appearance light`).
...
`screens/DeviceScreen.tsx` (refeita em 22/08/2026) é o caso de referência —
evidência em `05-topo-claro.png` / `06-topo-corrigido.png`:
