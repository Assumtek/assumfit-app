...
A duplicação da matemática entre TypeScript e Python foi mantida de propósito, o app precisa funcionar sem rede, e está protegida por teste de paridade que
...
correlações consumindo `/insights`, e exercitar cadastro e login pela interface, hoje validados por `curl` e por teste, não por toque na tela.
